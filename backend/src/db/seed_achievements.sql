...
-- Open / Any Tournament
('elite_four',        'Elite Four',                  'Place top 4 in any tournament.',                             '🌟',  'open',    NULL),
...
('ffc_elite_four',    'FFC Elite Four',              'Place top 4 in a Ferrum Fist Challenge event.',              '🌟',  'ffc',     'ffc'),
...
('rtgna_elite_four',  'RTG Elite Four',              'Place top 4 in a Road to Greatness NA event.',               '🌟',  'rtg_na',  'rtg_na'),
...
('rtgeu_elite_four',  'RTG EU Elite Four',           'Place top 4 in a Road to Greatness EU event.',               '🌟',  'rtg_eu',  'rtg_eu'),
...
('dcm_elite_four',    'DCM Elite Four',              'Place top 4 in a DCM monthly event.',                        '🌟',  'dcm',     'dcm'),
...
('tcc_elite_four',    'TCC Elite Four',              'Place top 4 in a The Croissant Cup event.',                  '🌟',  'tcc',     'tcc'),
...
('eotr_elite_four',   'EOTR Elite Four',             'Place top 4 in an End of the Road event.',                   '🌟',  'eotr',    'eotr'),
...
('nezumi_elite_four',    'ねずみ杯 Elite Four',        'Place top 4 in a Nezumi Cup event.',                        '🌟',  'nezumi',          'nezumi'),
...
('nezumi_rookies_elite_four',    'Rookies Elite Four',         'Place top 4 in a Nezumi Cup Rookies event.',                 '🌟',  'nezumi_rookies',  'nezumi_rookies'),
